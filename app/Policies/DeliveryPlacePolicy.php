...
class DeliveryPlacePolicy
{
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, DeliveryPlace $deliveryPlace)
    {
        //
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, DeliveryPlace $deliveryPlace)
    {
        //
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, DeliveryPlace $deliveryPlace)
    {
        //
    }
}
